        ...
        <RoleGuard allowedRoles={['Manager']}>
            <div className="flex h-full flex-col p-8">
                <header className="mb-8">
                    ...
                    <p className="mt-2 text-slate-500">View revenue, popular items, and historical sales data.</p>
                </header>
                <div className="flex-1 rounded-xl border-2 border-dashed border-slate-200 bg-slate-50 flex items-center justify-center">
                    <span className="text-slate-400 font-medium">Sales Reports module placeholder</span>
                </div>
            </div>
        </RoleGuard>
    );
